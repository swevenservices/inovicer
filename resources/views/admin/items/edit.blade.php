    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.items.update", [$item->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-12">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $item->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('cost_price') ? 'is-invalid' : '' }}" type="number" name="cost_price" id="cost_price" value="{{ old('cost_price', $item->cost_price) }}" step="0.01">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('sale_price') ? 'is-invalid' : '' }}" type="text" name="sale_price" id="sale_price" value="{{ old('sale_price', $item->sale_price) }}">
