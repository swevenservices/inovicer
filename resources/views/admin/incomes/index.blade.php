...
@section('content')
    <div class="flex flex-wrap justify-between mb-4">
        <h3><i class="fa fa-credit-card-alt"></i>
            All Incomes   <a class="btn btn-success" href="{{ route('admin.incomes.create') }}">{{ trans('global.add') }} {{ trans('cruds.income.title_singular') }}</a>
        </h3>
    </div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table  datatable datatable-Income">
                <thead>
                    <tr>
                        <th width="10">
